...
${themes.map((t) => `  - ${t.id} (${t.name})`).join("\n")}`;
  ...
  const renderSection = () => {
    switch (activeSection) {
      case "about":
        return <About theme={currentTheme} />;
      case "heatmaps":
        return <Stats theme={currentTheme} />;
      case "projects":
        return <Projects theme={currentTheme} />;
      case "pomodoro":
        return <Pomodoro theme={currentTheme} />;
      case "blog":
        return <Blog theme={currentTheme} />;
      default:
        return <About theme={currentTheme} />;
    }
  };
